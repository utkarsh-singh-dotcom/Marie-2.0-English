...
def promote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    message.reply_text("Hey! Hey! Wait a sec! Yeah i promoted🧡")
    return "<b>{}:</b>" \
           "\n#PROMOTED" \
           "\n<b>Admin:</b> {}" \
...
def demote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if user_member.status == 'creator':
        message.reply_text("Huh! I cant ban creator of the group.... 😬")
        return ""

    if not user_member.status == 'administrator':
        message.reply_text("I Can't demote what wasn't promoted ever by me😝!")
        return ""

    if user_id == bot.id:
        message.reply_text("Hey Hey! I can't demote myself😝! Get an admin to do it for me😘.")
        return ""
    ...
    try:
        ...
        message.reply_text("Hey! Could not demote. I might not be admin😝, or the admin status was appointed by another "
